...
class DomainOptionsStructure {
    ...
    public short playerFontSize;
    public String playerFontName;
    public boolean suppressAgentNotPresentWarning;
    public TColor selectedItemColor;
    public TColor selectedTextColor;
    public TColor commandTextColorInMap;
    ...
    public short tableFontSize;
    public short mapFontSize;
    public short browserFontSize;
    public boolean showRuleEditor;
    public boolean showButtonBar;
    public short browseBy;
    public short pageShowing;
    public boolean buttonSymbols;
    public TRect consoleWindowRect;
    public TRect editorWindowRect;
    public TRect logFileWindowRect;
    ...
    public TRect pictureWindowRect;
}
...
// var
TSDomain domain = new TSDomain();


// const
kUnsavedWorldFileName = "untitled";


// const
kUnsavedSessionFileName = "untitled";
...
// editor
// windows
class TSDomain extends TObject {
    public TWorld world;
    ...
    public void loadFileAtStartupAndInitializeForms() {
        ...
        if ((!this.registered) && (Year >= 2000)) {
            MessageDialog("This evaluation copy of StoryHarp is out of date." + Character(13) + Character(13) + "Please check for an updated evaluation version at:" + Character(13) + "http://www.kurtz-fernhout.com" + Character(13) + Character(13) + "The web site may also have updated pricing information." + Character(13) + "This message will disappear when the product is registered.", mtInformation, {mbOK, }, 0);
        }
    }
    ...
    public String loadIni(String section, String theField, String theDefault) {
        result = "";
        TIniFile iniFile = new TIniFile();
    ...
    public void setFormSize(TForm aForm, TRect newRect) {
        if (aForm == null) {
            return;
        }
