...
public class RegistrationWindow extends JFrame {
    ...
    public JPanel getDelphiPanel() {
        ...
        this.UserNameEdit.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        this.RegistrationCodeEdit.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent event) {
        ...
        this.EnableEditorButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent event) {
        ...
        this.OnlineRegistrationButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent event) {
