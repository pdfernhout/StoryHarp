...
// var
TChangeLogForm ChangeLogForm = new TChangeLogForm();


public void makeBackupCopy(String fileFrom, String fileTo) {
     fileFromCString = [0] * (range(0, 255 + 1) + 1);
     fileToCString = [0] * (range(0, 255 + 1) + 1);
...
class TChangeLogForm extends TForm {
    public TRichEdit LogContentsRichEdit;
    public TOpenDialog OpenDialog;
    public TPanel bottomPanel;
    public TButton CopySelectedTextButton;
    public TButton UpdateButton;
    public TButton changeLogFile;
    public TButton clearLogFile;
    ...
    public void fileErrorWarning() {
        ...
        ShowMessage("Could not write to the log file " + usdomain.domain.options.logFileName + Character(13) + Character(10) + "The file may be write protected or in use by another program, or your disk may be full." + Character(13) + Character(10) + "Your changes will not be logged.");
    ...
    public void CopySelectedTextButtonClick(TObject Sender) {
    ...
    public void UpdateButtonClick(TObject Sender) {
        this.loadChangeLog();
        this.scrollLogEndIntoView();
    }
    
    public void bottomPanelResize(TObject Sender) {
    ...
    public void clearLogFileClick(TObject Sender) {
    ...
    public void changeLogFileClick(TObject Sender) {
        String backupLogFileName = "";
