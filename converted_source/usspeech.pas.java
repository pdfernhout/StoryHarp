...
// const
commandListCommand = "options";


// const
repeatLastSayCommand = "say that again";
...
// const
firstRiddleAnswer = "say an answer for a riddle";
...
public String findFileInDirectoryRecursive(String fileName, String searchDir) {
    result = "";
    SysUtils.TSearchRec searchRec = new SysUtils.TSearchRec();
...
public String getWindowsMediaDirectory() {
    result = "";
...
public String findFileRecursivelyInMediaDirectories(String fileName, String extraMediaDirectory) {
    result = "";
    String worldFileDirectory = "";
    String exeDirectory = "";
    String windowsMediaDirectory = "";
...
class TSSpeechSystem extends TObject {
    public TStringList commandsListenedFor;
    ...
    public void create() {
        boolean tryToLaunchAgent = false;
        TAgentWarningForm AgentWarningForm = new TAgentWarningForm();
    ...
    public void loadAgentCharacter(String fileName) {
    ...
    public void AgentCommand(TObject Sender, IDispatch UserInput) {
